package com.dogecoding.android_embedded.inertia.components.power_train.servo_actuator.log
...
class ServoActuatorLogFormatter : TagLogFormatter(Model.LOG_TAG) {

    override fun format(context: Context, log: LogDbRecord): CharSequence {
        val builder = SpannableStringBuilder()
        builder.append("[SERVO ACTUATOR] ")
