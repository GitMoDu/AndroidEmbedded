package com.dogecoding.embedded.uart_interface.async

import android.util.Log
import androidx.fragment.app.Fragment
import com.dogecoding.embedded.uart_interface.UartMessenger
...
open class UartInterfaceManager(
    ...
    private val messenger =
        UartMessenger(baudRate, key, uartCheckPeriodMillis, messageStackSize, maxPayloadSize)
