...
class MessageUnitTest {
    ...
    fun messageEncodeDecodeMatch() {
        ...
        assert(messageEncodeDecode(3u, Cobs.Companion.MAX_COBS_MESSAGE_SIZE - Message.Companion.getMessageSize(0)))
    }
    ...
    private fun messageEncodeDecode(header: UByte, payloadSize: Int): Boolean {
        ...
        val size = Message.Companion.getMessageSize(payloadSize)
